                        ...
                        <table style={{width:'100%',borderCollapse:'collapse',minWidth:900}}>
                          <thead>
                            <tr>
                              ...
                              {scPastCols.map(c=><th key={c.k} style={{...scTh,fontSize:10}}>Mês</th>)}
                              {scHasCur && <>
                                <th colSpan={3} style={{...scTh,background:'#fef2f2',fontSize:11,textAlign:'center'}}>Mês</th>
                                <th colSpan={4} style={{...scTh,background:'#f1f5f9',fontSize:11,textAlign:'center'}}>MTD</th>
                              </>}
                            </tr>
                            <tr style={{background:'#f8fafc'}}>
