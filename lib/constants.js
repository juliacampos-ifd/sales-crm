...
export const PRODUCTS = {
  "3s": {
    ...
    responsaveis: ["Lidia Esteves / Gabriela Roma", "Joao Biagiotti / Diego Santos", "Emerson", "Leonardo Roso"]
  },
  "saipos": {
    name: "Saipos",
    color: "#3b82f6",
  ...
  "comer_fora": {
    ...
    responsaveis: ["Lidia Esteves / Gabriela Roma", "Joao Biagiotti / Diego Santos", "Emerson", "Leonardo Roso", "Lucas", "Marcos", "Mariana Peruzzetto"]
  },
  "get_in": {
    name: "GetIn",
    color: "#22c55e",
